...
namespace DBreezeBased.DocumentsStorage
{
    ...
    public class Storage
    {
        ...
        public void StartDocumentsIndexing()
        {
            ...
            System.Threading.Tasks.Task.Run(() => this.ProcessDocsAtOnce());
                            ...
                            else
                            {
                                        ...
                                        )
                                {
                                    ...
                                    if (docVersion.InternalStructure != null)  //In case if this document has searchables inside
                                    {
                                        ...
                                        {
                                            //Not compressed
                                            xmbr = btSearchanbles.Substring(1);
                                            docVersion.Searchables = System.Text.Encoding.UTF8.GetString(xmbr,0,xmbr.Length);
                                        }
                                        else
                                        {
                                            //Compressed
                                            xmbr = btSearchanbles.Substring(1).DecompressGZip();
                                            docVersion.Searchables = System.Text.Encoding.UTF8.GetString(xmbr, 0, xmbr.Length);
                                        }
        ...
        void Verbose(string format, params object[] args)
        {
            if (VerboseConsoleEnabled)
            {
                ...
                System.Diagnostics.Debug.WriteLine("DBreezeBased.DocumentStorage. ");
        ...
        Document RetrieveDocument(bool includeContent, bool includeSearchables, DBreeze.DataTypes.NestedTable dt, DBreeze.DataTypes.Row<int,byte[]> docRow)
        {
            ...
            if (includeSearchables && doc.InternalStructure != null)
            {
                ...
                doc.Searchables = System.Text.Encoding.UTF8.GetString(btSearchables,0, btSearchables.Length);
            }
